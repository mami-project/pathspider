...
with open(path.join(here, 'pathspider', 'VERSION')) as version_file:
...
setup(
    ...
    description='Tools for measuring path transparency in the Internet.',
    ...
    install_requires=['ipfix', 'bencodepy', 'numpy', 'pandas', 'py3dns'],
